...
class BookedRoomByDayGroupsExport implements FromView, ShouldAutoSize, WithStyles, WithEvents, WithTitle
{
    ...
    */
    public function view(): View
    {
        ...
        return view('exports/booking-by-day-excel-template', [
            'date' => now(),
            'bookings' => BookedRoomDay::with(['room', 'booking.target'])->whereRelation('booking', 'target_type', '=', "App\\Models\\Group")->get()
        ]);
    }
